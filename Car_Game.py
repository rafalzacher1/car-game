# Car Game
# Rafal Zacher 16/11/2018

import pygame, time, genMaze, Library_File_1 as library, Library_File_Help as help


log_file_name = "ZAC15107943.txt"                                   # Identify the log file name
factory_layout = "Rafal_Factory.csv"                                # Factory map
file_object = library.open_log_file(log_file_name, "a")             # Open the file in append mode
print()
help.welcome_autonomous_vehicle()                                   # Prints a greeting message and information about the program
print()
...
def start_run():
    print("Starting...")
    car = genMaze.Car()
    genMaze.main(factory_layout, car)
    car.filedata = genMaze.filedata                         # Pass the factory map to the car
    ...
    while not car.Finished:
        ...
        for event in pygame.event.get():
            ...
            genMaze.render(car)     # Genders the map to update any movements
